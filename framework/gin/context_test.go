...
import (
	...
	"github.com/jader1992/gocore/framework/gin/binding"
	"github.com/stretchr/testify/assert"

	testdata "github.com/jader1992/gocore/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/jader1992/gocore/framework/gin.handlerNameTest$", c.HandlerName())
}
